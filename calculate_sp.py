...
with open(configure_src, 'r', encoding='utf-8') as file:
    data_dict = json.load(file)
print(data_dict)
print(data_dict['stage'])
print(data_dict['ban_list'])

# 重要参数
p_list = data_dict['ban_list']
file_src = './out_' + data_dict['stage'] + '.txt'
